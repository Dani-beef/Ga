(function ($) {
    ...
    $.fn.extend({
        maxlength: function (options, callback) {
            ...
            options.placement = $(this).attr("data-maxlength-position") ? $(this).attr("data-maxlength-position") : options.placement;
           ...
           */
            function place(currentInput, maxLengthIndicator) {
              if ($(maxLengthIndicator).length)
              {
                ...
                case 'bottom':
                    maxLengthIndicator.css({top: pos.top + pos.height + 5, left: pos.left + pos.width / 2 - actualWidth / 2});
                    break;
                case 'top':
                    maxLengthIndicator.css({top: pos.top - actualHeight - 5, left: pos.left + pos.width / 2 - actualWidth / 2});
                    break;
                case 'left':
                    maxLengthIndicator.css({top: pos.top + pos.height / 2 - actualHeight / 2, left: pos.left - actualWidth - 5});
                    break;
                case 'right':
                    maxLengthIndicator.css({top: pos.top + pos.height / 2 - actualHeight / 2, left: pos.left + pos.width + 5});
                    break;
                case 'bottom-right':
