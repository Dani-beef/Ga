    ...
    <div class="row-fluid">
      <div class="col-md-3">
        ...
        <ul class="nav nav-pills nav-stacked">
			    ...
			    <li class="active"><a href="{$config.url}pages/page/terms-of-service/">Terms of Service</a></li>
			    <li><a href="{$config.url}pages/page/privacy-policy">Privacy Policy</a></li>
			  </ul>
			  </div>
      </div>
...
<p>
    <strong>Reliance On Information Posted &amp; Disclaimer</strong>
</p>
<p>
...
<p>
    <strong>Our site changes regularly</strong>
</p>
<p>
...
<p>
    <strong>Information about you and your visits to our site</strong>
</p>
<p>
    We process information about you in accordance with our privacy policy [<em><u>http://secretrepublic.net/pages/pages/privacy-policy</u></em>]. By using our
...
<hr/>
This document was last updated on March 23, 2014
</div>
      </div>
    </div>
  </div>
